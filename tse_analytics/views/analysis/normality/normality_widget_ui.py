...
class Ui_NormalityWidget(object):
    def setupUi(self, NormalityWidget):
        ...
        self.splitter = QSplitter(NormalityWidget)
    ...
    def retranslateUi(self, NormalityWidget):
        self.groupBoxVariable.setTitle(QCoreApplication.translate("NormalityWidget", u"Variable", None))
        self.groupBoxSplitMode.setTitle(QCoreApplication.translate("NormalityWidget", u"Split Mode", None))
        self.radioButtonSplitTotal.setText(QCoreApplication.translate("NormalityWidget", u"Total", None))
        self.radioButtonSplitByAnimal.setText(QCoreApplication.translate("NormalityWidget", u"By Animal", None))
        self.radioButtonSplitByRun.setText(QCoreApplication.translate("NormalityWidget", u"By Run", None))
        self.radioButtonSplitByFactor.setText(QCoreApplication.translate("NormalityWidget", u"By Factor", None))
        self.pushButtonUpdate.setText(QCoreApplication.translate("NormalityWidget", u"Update", None))
        self.pushButtonAddReport.setText(QCoreApplication.translate("NormalityWidget", u"Add to Report", None))
        self.pushButtonHelp.setText(QCoreApplication.translate("NormalityWidget", u"Help", None))
        pass
    # retranslateUi
