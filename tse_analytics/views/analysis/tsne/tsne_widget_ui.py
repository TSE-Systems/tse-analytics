...
################################################################################
## Form generated from reading UI file 'tsne_widget.ui'
##
...
class Ui_TsneWidget(object):
    def setupUi(self, TsneWidget):
        if not TsneWidget.objectName():
            TsneWidget.setObjectName(u"TsneWidget")
        self.verticalLayout = QVBoxLayout(TsneWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.splitter = QSplitter(TsneWidget)
        ...
        self.retranslateUi(TsneWidget)

        QMetaObject.connectSlotsByName(TsneWidget)
    # setupUi

    def retranslateUi(self, TsneWidget):
        self.groupBoxVariables.setTitle(QCoreApplication.translate("TsneWidget", u"Variables", None))
        self.groupBoxSplitMode.setTitle(QCoreApplication.translate("TsneWidget", u"Split Mode", None))
        self.radioButtonSplitTotal.setText(QCoreApplication.translate("TsneWidget", u"Total", None))
        self.radioButtonSplitByAnimal.setText(QCoreApplication.translate("TsneWidget", u"By Animal", None))
        self.radioButtonSplitByRun.setText(QCoreApplication.translate("TsneWidget", u"By Run", None))
        self.radioButtonSplitByFactor.setText(QCoreApplication.translate("TsneWidget", u"By Factor", None))
        self.pushButtonUpdate.setText(QCoreApplication.translate("TsneWidget", u"Update", None))
        self.pushButtonAddReport.setText(QCoreApplication.translate("TsneWidget", u"Add to Report", None))
        self.pushButtonHelp.setText(QCoreApplication.translate("TsneWidget", u"Help", None))
        pass
    # retranslateUi
