...
################################################################################
## Form generated from reading UI file 'mixed_anova_widget.ui'
##
...
class Ui_MixedAnovaWidget(object):
    def setupUi(self, MixedAnovaWidget):
        if not MixedAnovaWidget.objectName():
            MixedAnovaWidget.setObjectName(u"MixedAnovaWidget")
        self.verticalLayout = QVBoxLayout(MixedAnovaWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.splitter = QSplitter(MixedAnovaWidget)
        ...
        self.retranslateUi(MixedAnovaWidget)

        QMetaObject.connectSlotsByName(MixedAnovaWidget)
    # setupUi

    def retranslateUi(self, MixedAnovaWidget):
        self.groupBoxFactors.setTitle(QCoreApplication.translate("MixedAnovaWidget", u"Factors", None))
        self.groupBoxDependentVariable.setTitle(QCoreApplication.translate("MixedAnovaWidget", u"Dependent Variable", None))
        self.groupBoxPAdjustment.setTitle(QCoreApplication.translate("MixedAnovaWidget", u"P-values adjustment", None))
