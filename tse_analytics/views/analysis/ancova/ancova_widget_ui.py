...
class Ui_AncovaWidget(object):
    def setupUi(self, AncovaWidget):
        ...
        self.tableWidgetCovariates.setSelectionMode(QAbstractItemView.SelectionMode.MultiSelection)
    ...
    def retranslateUi(self, AncovaWidget):
        self.groupBoxFactors.setTitle(QCoreApplication.translate("AncovaWidget", u"Factors", None))
        self.groupBoxDependentVariable.setTitle(QCoreApplication.translate("AncovaWidget", u"Dependent Variable", None))
        self.groupBoxCovariates.setTitle(QCoreApplication.translate("AncovaWidget", u"Covariates", None))
        self.groupBoxPAdjustment.setTitle(QCoreApplication.translate("AncovaWidget", u"P-values adjustment", None))
        self.groupBoxEffectSizeType.setTitle(QCoreApplication.translate("AncovaWidget", u"Effect size type", None))
        self.pushButtonUpdate.setText(QCoreApplication.translate("AncovaWidget", u"Update", None))
        self.pushButtonAddReport.setText(QCoreApplication.translate("AncovaWidget", u"Add to Report", None))
        self.pushButtonHelp.setText(QCoreApplication.translate("AncovaWidget", u"Help", None))
        pass
    # retranslateUi
