...
class Ui_FactorsDialog(object):
    def setupUi(self, FactorsDialog):
        if not FactorsDialog.objectName():
            FactorsDialog.setObjectName("FactorsDialog")
        ...
        self.pushButtonExtractGroups.setObjectName("pushButtonExtractGroups")
        ...
        self.comboBoxFields.setObjectName("comboBoxFields")
        ...
        self.groupBoxAnimals.setObjectName("groupBoxAnimals")
    ...
    def retranslateUi(self, FactorsDialog):
        FactorsDialog.setWindowTitle(QCoreApplication.translate("FactorsDialog", "Factors", None))
        self.groupBoxFactors.setTitle(QCoreApplication.translate("FactorsDialog", "Factors", None))
        self.pushButtonAddFactor.setText(QCoreApplication.translate("FactorsDialog", "Add Factor", None))
        self.pushButtonDeleteFactor.setText(QCoreApplication.translate("FactorsDialog", "Delete Factor", None))
        self.groupBoxGroups.setTitle(QCoreApplication.translate("FactorsDialog", "Groups", None))
        self.pushButtonAddGroup.setText(QCoreApplication.translate("FactorsDialog", "Add Group", None))
        self.pushButtonDeleteGroup.setText(QCoreApplication.translate("FactorsDialog", "Delete Group", None))
        self.pushButtonExtractGroups.setText(QCoreApplication.translate("FactorsDialog", "Extract from...", None))
        self.groupBoxAnimals.setTitle(QCoreApplication.translate("FactorsDialog", "Animals", None))
