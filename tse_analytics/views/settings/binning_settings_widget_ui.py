...
class Ui_BinningSettingsWidget(object):
    def setupUi(self, BinningSettingsWidget):
        ...
        self.formLayout_2.setWidget(0, QFormLayout.LabelRole, self.unitLabel)

        self.unitComboBox = QComboBox(self.groupBoxIntervals)
        self.unitComboBox.setObjectName(u"unitComboBox")

        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.unitComboBox)

        self.deltaLabel = QLabel(self.groupBoxIntervals)
        self.deltaLabel.setObjectName(u"deltaLabel")

        self.formLayout_2.setWidget(1, QFormLayout.LabelRole, self.deltaLabel)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.FieldRole, self.deltaSpinBox)
        ...
        self.formLayout_3.setWidget(0, QFormLayout.LabelRole, self.labelLightCycleStart)
        ...
        self.formLayout_3.setWidget(0, QFormLayout.FieldRole, self.timeEditLightCycleStart)

        self.labelDarkCycleStart = QLabel(self.groupBoxCycles)
        self.labelDarkCycleStart.setObjectName(u"labelDarkCycleStart")

        self.formLayout_3.setWidget(1, QFormLayout.LabelRole, self.labelDarkCycleStart)
        ...
        self.formLayout_3.setWidget(1, QFormLayout.FieldRole, self.timeEditDarkCycleStart)
