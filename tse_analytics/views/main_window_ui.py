...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons8-settings-16.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSettings.setIcon(icon6)
        self.actionSettings.setMenuRole(QAction.MenuRole.NoRole)
        self.actionNewWorkspace = QAction(MainWindow)
        self.actionNewWorkspace.setObjectName(u"actionNewWorkspace")
        icon7 = QIcon()
