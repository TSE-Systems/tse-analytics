...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionewfw.setObjectName("actionewfw")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionewfw.setText(QCoreApplication.translate("MainWindow", "ewfw", None))
        self.actionExportCsv.setText(QCoreApplication.translate("MainWindow", "Export to CSV", None))
        # if QT_CONFIG(tooltip)
        self.actionExportCsv.setToolTip(QCoreApplication.translate("MainWindow", "Export to CSV...", None))
        # endif // QT_CONFIG(tooltip)
        self.menuFile.setTitle(QCoreApplication.translate("MainWindow", "&File", None))
        self.menuOpenRecent.setTitle(QCoreApplication.translate("MainWindow", "Open Recent", None))
