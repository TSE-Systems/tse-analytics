...
class AncovaWidget(ToolboxWidgetBase):
    ...
    def _create_toolbar_items(self, toolbar: QToolBar) -> None:
        ...
        self.variable_selector.set_data(self.datatable.variables, selected_variable=self._settings.dependent_variable)
        ...
        self.covariate_selector.set_data(self.datatable.variables, selected_variable=self._settings.covariate)
    ...
    def _update(self):
        ...
        covariate = self.covariate_selector.get_selected_variable()
