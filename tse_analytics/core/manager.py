...
from tse_analytics.core.dataset_merger import merge
...
class Manager:
    ...
    def merge_datasets(
        ...
        merged_dataset = merge(new_dataset_name, datasets, single_run, continuous_mode, generate_new_animal_names)
