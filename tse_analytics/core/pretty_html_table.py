                        ...
                        try:
                            if int(repr(line).split(">")[1].split("<")[0]) < conditions[k]["min"]:
                                if "color: black" in repr(line):
                                    width_body = (
                                        width_body
                                        + repr(line).replace("color: black", "color: " + conditions[k]["min_color"])[1:]
                                    )
                                elif "color: white" in repr(line):
                                    width_body = (
                                        width_body
                                        + repr(line).replace("color: white", "color: " + conditions[k]["min_color"])[1:]
                                    )
                                else:
                                    width_body = (
                                        width_body
                                        + repr(line).replace('">', "; color: " + conditions[k]["min_color"] + '">')[1:]
                                    )
                                updated_body = True
                                ...
                                if "color: black" in repr(line):
                                    width_body = (
                                        width_body
                                        + repr(line).replace("color: black", "color: " + conditions[k]["max_color"])[1:]
                                    )
                                elif "color: white" in repr(line):
                                    width_body = (
                                        width_body
                                        + repr(line).replace("color: white", "color: " + conditions[k]["max_color"])[1:]
                                    )
                                else:
                                    width_body = (
                                        width_body
                                        + repr(line).replace('">', "; color: " + conditions[k]["max_color"] + '">')[1:]
                                    )
                                updated_body = True
                        except:
                            pass
