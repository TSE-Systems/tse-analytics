...
from PySide6.QtWidgets import QGridLayout, QSplitter, QGroupBox, QApplication, QHBoxLayout, QWidget
from PySide6.QtGui import QPainter, QColor, QFont, QResizeEvent
