...
def preprocess_main_table(dataset: IMDataset, sampling_interval: pd.Timedelta) -> IMDataset:
    ...
    datetime_range = pd.date_range(experiment_started.round("Min"), experiment_stopped.round("Min"), freq=sampling_interval)
    ...
    for i, animal_id in enumerate(animal_ids):
        ...
        preprocessed_df = _preprocess_animal(animal_id, animal_to_box_map[animal_id], animal_data, datetime_range, sampling_interval, agg)
