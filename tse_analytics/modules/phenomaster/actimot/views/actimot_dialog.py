...
from tse_analytics.modules.phenomaster.actimot.actimot_processor import process_actimot_data
...
from tse_analytics.modules.phenomaster.actimot.views.actimot_gap_plot_widget import ActimotGapPlotWidget
...
class ActimotDialog(QDialog):
    def __init__(self, actimot_details: ActimotDetails, parent: QWidget | None = None):
        ...
        self.actimot_gap_plot_widget = ActimotGapPlotWidget()
        self.ui.tabWidget.addTab(self.actimot_gap_plot_widget, "Gap")
        ...
        self.actimot_events_df: pd.DataFrame | None = self.actimot_details.raw_df
    ...
    def __calculate(self):
        ...
        self.__run_analysis(actimot_settings)
    ...
    def __run_analysis(
        self,
        actimot_settings: ActimotSettings,
    ):
        self.meal_intervals_df = process_actimot_data(self.actimot_details, actimot_settings)
