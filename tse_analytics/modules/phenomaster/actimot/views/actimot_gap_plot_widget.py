...
from tse_analytics.modules.phenomaster.actimot.views.actimot_mpl_plot_widget_ui import Ui_ActimotMplPlotWidget


class ActimotGapPlotWidget(QWidget):
    def __init__(self, parent: QWidget | None = None):
        super().__init__(parent)

        self.ui = Ui_ActimotMplPlotWidget()
