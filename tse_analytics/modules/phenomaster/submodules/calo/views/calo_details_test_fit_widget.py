...
from tse_analytics.modules.phenomaster.submodules.calo.views.calo_details_settings_widget import (
    CaloDetailsSettingsWidget,
)
from tse_analytics.modules.phenomaster.submodules.calo.views.calo_details_test_fit_widget_ui import (
    Ui_CaloDetailsTestFitWidget,
)
