...
from tse_analytics.modules.phenomaster.submodules.calo.views.plot.plot_view import PlotView
...
class Ui_PlotWidget(object):
    ...
    def retranslateUi(self, PlotWidget):
        PlotWidget.setWindowTitle(QCoreApplication.translate("PlotWidget", u"Form", None))
