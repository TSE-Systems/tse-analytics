...
################################################################################
## Form generated from reading UI file 'gas_settings_widget.ui'
##
...
class Ui_GasSettingsWidget(object):
    def setupUi(self, GasSettingsWidget):
        if not GasSettingsWidget.objectName():
            GasSettingsWidget.setObjectName(u"GasSettingsWidget")
        self.verticalLayout = QVBoxLayout(GasSettingsWidget)
        self.verticalLayout.setSpacing(2)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(2, 2, 2, 2)
        self.titleGroupBox = QGroupBox(GasSettingsWidget)
        ...
        self.tabWidget = QTabWidget(GasSettingsWidget)
        ...
        self.retranslateUi(GasSettingsWidget)

        self.tabWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(GasSettingsWidget)
    # setupUi

    def retranslateUi(self, GasSettingsWidget):
        GasSettingsWidget.setWindowTitle(QCoreApplication.translate("GasSettingsWidget", u"Form", None))
        self.titleGroupBox.setTitle(QCoreApplication.translate("GasSettingsWidget", u"[Gas Name]", None))
        self.trainingIntervalGroupBox.setTitle(QCoreApplication.translate("GasSettingsWidget", u"Training Interval", None))
        self.groupBoxA.setTitle(QCoreApplication.translate("GasSettingsWidget", u"a", None))
        self.groupBoxB.setTitle(QCoreApplication.translate("GasSettingsWidget", u"b", None))
        self.groupBoxC.setTitle(QCoreApplication.translate("GasSettingsWidget", u"C", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabBounds), QCoreApplication.translate("GasSettingsWidget", u"Bounds", None))
        self.groupBoxRefA.setTitle(QCoreApplication.translate("GasSettingsWidget", u"a", None))
        self.groupBoxRefB.setTitle(QCoreApplication.translate("GasSettingsWidget", u"b", None))
        self.groupBoxRefC.setTitle(QCoreApplication.translate("GasSettingsWidget", u"C", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRefBounds), QCoreApplication.translate("GasSettingsWidget", u"Reference Bounds", None))
    # retranslateUi
