...
from tse_analytics.modules.phenomaster.submodules.calo.views.settings.gas_settings.gas_settings_widget import GasSettingsWidget
...
class Ui_SettingsWidget(object):
    def setupUi(self, SettingsWidget):
        ...
        self.widgetO2Settings = GasSettingsWidget(self.groupBoxGasSettings)
        self.widgetO2Settings.setObjectName(u"widgetO2Settings")

        self.verticalLayout_3.addWidget(self.widgetO2Settings)

        self.widgetCO2Settings = GasSettingsWidget(self.groupBoxGasSettings)
    ...
    def retranslateUi(self, SettingsWidget):
        self.groupBoxGeneralSettings.setTitle(QCoreApplication.translate("SettingsWidget", u"General", None))
        self.iterationsLabel.setText(QCoreApplication.translate("SettingsWidget", u"Iterations", None))
        self.predictionOffsetLabel.setText(QCoreApplication.translate("SettingsWidget", u"Prediction Offset", None))
        self.flowLabel.setText(QCoreApplication.translate("SettingsWidget", u"Flow [l/min]", None))
        self.groupBoxGasSettings.setTitle(QCoreApplication.translate("SettingsWidget", u"Gas Settings", None))
        pass
    # retranslateUi
