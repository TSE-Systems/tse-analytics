...
from tse_analytics.modules.phenomaster.submodules.calo.views.calo_settings_widget_ui import Ui_CaloSettingsWidget


class CaloSettingsWidget(QWidget):
    def __init__(self, parent: QWidget | None = None):
        super().__init__(parent)

        self.ui = Ui_CaloSettingsWidget()
