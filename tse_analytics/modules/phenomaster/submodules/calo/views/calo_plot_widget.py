...
from tse_analytics.modules.phenomaster.submodules.calo.views.calo_plot_widget_ui import Ui_CaloPlotWidget


class CaloPlotWidget(QWidget):
    def __init__(self, parent: QWidget | None = None):
        super().__init__(parent)

        self.ui = Ui_CaloPlotWidget()
