...
################################################################################
## Form generated from reading UI file 'calo_gas_settings_widget.ui'
##
...
class Ui_CaloGasSettingsWidget(object):
    def setupUi(self, CaloGasSettingsWidget):
        if not CaloGasSettingsWidget.objectName():
            CaloGasSettingsWidget.setObjectName(u"CaloGasSettingsWidget")
        self.verticalLayout = QVBoxLayout(CaloGasSettingsWidget)
        self.verticalLayout.setSpacing(2)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(2, 2, 2, 2)
        self.titleGroupBox = QGroupBox(CaloGasSettingsWidget)
        ...
        self.tabWidget = QTabWidget(CaloGasSettingsWidget)
        ...
        self.retranslateUi(CaloGasSettingsWidget)

        self.tabWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(CaloGasSettingsWidget)
    # setupUi

    def retranslateUi(self, CaloGasSettingsWidget):
        CaloGasSettingsWidget.setWindowTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"Form", None))
        self.titleGroupBox.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"[Gas Name]", None))
        self.trainingIntervalGroupBox.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"Training Interval", None))
        self.groupBoxA.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"a", None))
        self.groupBoxB.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"b", None))
        self.groupBoxC.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"C", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabBounds), QCoreApplication.translate("CaloGasSettingsWidget", u"Bounds", None))
        self.groupBoxRefA.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"a", None))
        self.groupBoxRefB.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"b", None))
        self.groupBoxRefC.setTitle(QCoreApplication.translate("CaloGasSettingsWidget", u"C", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRefBounds), QCoreApplication.translate("CaloGasSettingsWidget", u"Reference Bounds", None))
    # retranslateUi
