...
from tse_analytics.modules.phenomaster.submodules.drinkfeed.views.meal_episodes_plot_widget_ui import (
    Ui_MealEpisodesPlotWidget,
)


class MealEpisodesIntakePlotWidget(QWidget):
