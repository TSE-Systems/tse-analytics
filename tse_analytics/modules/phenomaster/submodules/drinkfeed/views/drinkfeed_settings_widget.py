...
from tse_analytics.modules.phenomaster.submodules.drinkfeed.views.drinkfeed_settings_widget_ui import (
    Ui_DrinkFeedSettingsWidget,
)


class DrinkFeedSettingsWidget(QWidget):
    def __init__(self, parent: QWidget | None = None):
        super().__init__(parent)

        self.ui = Ui_DrinkFeedSettingsWidget()
