...
from tse_analytics.modules.phenomaster.submodules.drinkfeed.views.meal_details_settings_widget_ui import (
...
class MealDetailsSettingsWidget(QWidget):
    ...
    def set_data(self, dataset: PhenoMasterDataset, meal_details_settings: DrinkFeedDataSettings):
    ...
    def _set_settings(self, meal_details_settings: DrinkFeedDataSettings):
    ...
    def get_meal_details_settings(self) -> DrinkFeedDataSettings:
