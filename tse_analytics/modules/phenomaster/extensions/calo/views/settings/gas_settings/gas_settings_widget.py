...
from tse_analytics.modules.phenomaster.extensions.calo.calo_settings import CaloGasSettings
from tse_analytics.modules.phenomaster.extensions.calo.views.settings.gas_settings.gas_settings_widget_ui import (
    Ui_GasSettingsWidget,
)


class GasSettingsWidget(QWidget):
    def __init__(self, parent: QWidget | None = None):
        super().__init__(parent)

        self.ui = Ui_GasSettingsWidget()
