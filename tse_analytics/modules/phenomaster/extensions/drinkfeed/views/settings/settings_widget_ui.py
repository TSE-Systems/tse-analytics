...
class Ui_SettingsWidget(object):
    def setupUi(self, SettingsWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 277, 455))
    ...
    def retranslateUi(self, SettingsWidget):
        self.groupBoxAnalysisType.setTitle(QCoreApplication.translate("SettingsWidget", u"Analysis Type", None))
        self.radioButtonSequentialType.setText(QCoreApplication.translate("SettingsWidget", u"Sequential", None))
        self.radioButtonIntervalType.setText(QCoreApplication.translate("SettingsWidget", u"Interval", None))
        self.groupBoxSequentialSettings.setTitle(QCoreApplication.translate("SettingsWidget", u"Sequential Analysis", None))
        self.intermealIntervalLabel.setText(QCoreApplication.translate("SettingsWidget", u"Inter-meal Interval [hh:mm:ss]", None))
        self.intermealIntervalTimeEdit.setDisplayFormat(QCoreApplication.translate("SettingsWidget", u"HH:mm:ss", None))
        self.drinkingMinimumAmountLabel.setText(QCoreApplication.translate("SettingsWidget", u"Drinking Minimum Amount [ml]", None))
        self.feedingMinimumAmountLabel.setText(QCoreApplication.translate("SettingsWidget", u"Feeding Minimum Amount [g]", None))
        self.groupBoxIntervalSettings.setTitle(QCoreApplication.translate("SettingsWidget", u"Interval Analysis", None))
        self.fixedIntervalLabel.setText(QCoreApplication.translate("SettingsWidget", u"Fixed Interval [hh:mm:ss]", None))
        self.fixedIntervalTimeEdit.setDisplayFormat(QCoreApplication.translate("SettingsWidget", u"HH:mm:ss", None))
        self.groupBoxDiets.setTitle(QCoreApplication.translate("SettingsWidget", u"Diets", None))
#if QT_CONFIG(tooltip)
        self.toolButtonAddDiet.setToolTip(QCoreApplication.translate("SettingsWidget", u"Add diet", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.toolButtonDeleteDiet.setToolTip(QCoreApplication.translate("SettingsWidget", u"Delete selected diet", None))
#endif // QT_CONFIG(tooltip)
