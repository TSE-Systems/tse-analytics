...
def main():
    ...
    n_basic_a_vertical = graph.create_node("nodes.basic.BasicNodeA", name="Vertical Node", text_color="#feab20")
    ...
    n_svg_file_vertical = graph.create_node("nodes.basic.SVGNode", name="svg file", color="#0a1e20")
