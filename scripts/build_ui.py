...
UI_FILES = [
    ...
    ("tse_analytics/views/factors/factors_dialog.ui", "tse_analytics/views/factors/factors_dialog_ui.py"),
    ("tse_analytics/views/variables/add_variable_dialog.ui", "tse_analytics/views/variables/add_variable_dialog_ui.py"),
    ("tse_analytics/views/datasets/datasets_merge_dialog.ui", "tse_analytics/views/datasets/datasets_merge_dialog_ui.py"),
    ("tse_analytics/views/datasets/adjust_dataset_dialog.ui", "tse_analytics/views/datasets/adjust_dataset_dialog_ui.py"),
    ("tse_analytics/views/settings/binning_settings_widget.ui", "tse_analytics/views/settings/binning_settings_widget_ui.py"),
    ("tse_analytics/views/about/about_dialog.ui", "tse_analytics/views/about/about_dialog_ui.py"),
    ("tse_analytics/views/settings/settings_dialog.ui", "tse_analytics/views/settings/settings_dialog_ui.py"),
    # toolbox
