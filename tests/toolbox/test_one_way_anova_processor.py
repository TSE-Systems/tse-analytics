...
class TestOneWayAnova:
    ...
    def test_report_contains_anova_table(self, analysis_dataset):
        variable = analysis_dataset.datatables["Main"].variables["Metabolism"]
    ...
    def test_report_contains_normality(self, analysis_dataset):
        variable = analysis_dataset.datatables["Main"].variables["Metabolism"]
    ...
    def test_report_contains_post_hoc(self, analysis_dataset):
        variable = analysis_dataset.datatables["Main"].variables["Metabolism"]
    ...
    def test_report_contains_image(self, analysis_dataset):
        variable = analysis_dataset.datatables["Main"].variables["Metabolism"]
